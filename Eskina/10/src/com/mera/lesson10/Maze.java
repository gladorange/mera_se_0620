...
import com.mera.lesson10.generation.PassageTree;
import com.mera.lesson10.solving.Fugitive;
...
public class Maze {
     ...
     * @see Fugitive
     */
    public String findEscape(Player player) {
            new Fugitive(grid, getEntrance(), getExit(), player)
                .findEscape()
                .forEach(putCell());
